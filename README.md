...
- **Seguridad**: El archivo `.gitignore` ya está configurado para proteger tus secretos de Git.
...
### 3. Ejecutar el Bot
Para ver al bot trabajando en vivo (con navegador visible):
```powershell
...
- `config.py`: Parámetros de configuración global (URLs, Timeouts).
